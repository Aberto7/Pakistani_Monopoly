    ...
    public class PopupWindow : MonoBehaviour
    {
        ...
        public void DisplayPropertyInfo(int propertyNum)
        {
            if (propertyNum == -1) {
                ...
                text = text + "\n\nPrice: Rs 1500";
                text = text + "\n\nRent:\n1 utility owned: Rs 4 x diceroll";
                text = text + "\n2 utility owned: Rs 10 x diceroll";
                windowText.text = text;
            }
                ...
                text = text + "\nHouse price: Rs " + property.housePrice;
                text = text + "\nNumber of houses built: " + property.numHouses;
                int baseRent = property.baseRent;

                text = text + "\n\nRent:\n0 houses: Rs " + baseRent;
                text = text + "\n1 house: Rs " + (baseRent * 5);
                text = text + "\n2 houses: Rs " + (baseRent * 15);
                text = text + "\n3 houses: Rs " + (baseRent * 45);
                text = text + "\n4 houses: Rs " + ((baseRent * 45)+200);
                text = text + "\n5 houses (hotel): Rs " + ((baseRent * 45)+400);
                windowText.text = text;
            }
            this.gameObject.SetActive(true);
        }
