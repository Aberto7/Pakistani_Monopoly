...
namespace Monopoly
{
    public class Board : MonoBehaviour
    {
        ...
        public void SetUpLocations()
        {
            ...
            this.locations.Add(new Property("M.A. Jinnah Road", 60, 50, 2, new Vector3(-19.0f, 0f, 25.0f), new int[] {1, 3}));
            this.locations.Add(new Location("Community Chest", new Vector3(-15.0f, 0f, 25.0f)));
            this.locations.Add(new Property("Denso Hall", 60, 50, 4, new Vector3(-11.0f, 0f, 25.0f), new int[] {1, 3}));
            ...
            this.locations.Add(new Property("Burns Road", 100, 50, 6, new Vector3(3.0f, 0f, 25.0f), new int[] {6, 8, 9}));
            this.locations.Add(new Location("Chance", new Vector3(7.0f, 0f, 25.0f)));
            this.locations.Add(new Property("Liaquatabad", 100, 50, 6, new Vector3(12.0f, 0f, 25.0f), new int[] {6, 8, 9}));
            this.locations.Add(new Property("Numaish", 120, 50, 8, new Vector3(16.0f, 0f, 25.0f), new int[] {6, 8, 9}));
            this.locations.Add(new Location("Jail", new Vector3(23.0f, 0f, 25.0f)));
            this.locations.Add(new Property("Bolten Market", 140, 100, 10, new Vector3(23.0f, 0f, 19.0f), new int[] {11, 13, 14}));
            this.locations.Add(new Utility("Electric Company", new Vector3(23.0f, 0f, 14.0f)));
            this.locations.Add(new Property("Tower", 140, 100, 10, new Vector3(23.0f, 0f, 10.0f), new int[] {11, 13, 14}));
            this.locations.Add(new Property("Tariq Road", 160, 100, 12, new Vector3(23.0f, 0f, 5.0f), new int[] {11, 13, 14}));
            this.locations.Add(new Railroad("Cantt Station", new Vector3(23.0f, 0f, 0.0f)));
            this.locations.Add(new Property("Soldier Bazzar", 180, 100, 14, new Vector3(23.0f, 0f, -4.0f), new int[] {16, 18, 19}));
            this.locations.Add(new Location("Community Chest", new Vector3(23.0f, 0f, -8.0f)));
            this.locations.Add(new Property("New Karachi", 180, 100, 14, new Vector3(23.0f, 0f, -13.0f), new int[] {16, 18, 19}));
            this.locations.Add(new Property("Malir Cantt", 200, 100, 16, new Vector3(23.0f, 0f, -17.0f), new int[] {16, 18, 19}));
            this.locations.Add(new Location("Free Parking", new Vector3(23.0f, 0f, -24.0f)));
            this.locations.Add(new Property("Haideri Market", 220, 150, 18, new Vector3(17.0f, 0f, -24.0f), new int[] {21, 23, 24}));
            this.locations.Add(new Location("Chance", new Vector3(12.0f, 0f, -24.0f)));
            this.locations.Add(new Property("Saddar Market", 220, 150, 18, new Vector3(8.0f, 0f, -24.0f), new int[] {21, 23, 24}));
            this.locations.Add(new Property("Empress Market", 240, 150, 20, new Vector3(3.0f, 0f, -24.0f), new int[] {21, 23, 24}));
            this.locations.Add(new Railroad("Drigh Road Station", new Vector3(-1.0f, 0f, -24.0f)));
            this.locations.Add(new Property("Sarafa Bazzar", 260, 150, 22, new Vector3(-6.0f, 0f, -24.0f), new int[] {26, 27, 29}));
            this.locations.Add(new Property("Jama Cloth Market", 260, 150, 22, new Vector3(-10.0f, 0f, -24.0f), new int[] {26, 27, 29}));
            this.locations.Add(new Utility("Water Works", new Vector3(-15.0f, 0f, -24.0f)));
            this.locations.Add(new Property("Gulshan-e-Iqbal", 280, 150, 24, new Vector3(-19.0f, 0f, -24.0f), new int[] {26, 27, 29}));
            this.locations.Add(new Location("Go To Jail", new Vector3(-25.0f, 0f, -24.0f)));
            this.locations.Add(new Property("Gulzar-e-Hijri", 300, 200, 26, new Vector3(-25.0f, 0f, -18.0f), new int[] {31, 32, 34}));
            this.locations.Add(new Property("Juna Market", 300, 200, 26, new Vector3(-25.0f, 0f, -14.0f), new int[] {31, 32, 34}));
            this.locations.Add(new Location("Community Chest", new Vector3(-25.0f, 0f, -9.0f)));
            this.locations.Add(new Property("I.I. Chundrigar Road", 320, 200, 28, new Vector3(-25.0f, 0f, -4.0f), new int[] {31, 32, 34}));
            ...
            this.locations.Add(new Property("Clifton", 350, 200, 35, new Vector3(-25.0f, 0f, 10.0f), new int[] {37, 39}));
            this.locations.Add(new Tax("Luxury Tax", 100, new Vector3(-25.0f, 0f, 14.0f)));
            this.locations.Add(new Property("Keamari", 400, 200, 50, new Vector3(-25.0f, 0f, 19.0f), new int[] {37, 39}));
