...
namespace Monopoly
{
    public class Board : MonoBehaviour
    {
        ...
        public void SetUpLocations()
        {
            ...
            this.locations.Add(new Property("M.A. Jinnah Road", 5000, 500, 20, new Vector3(-19.0f, 0f, 25.0f), new int[] {1, 3}));
            this.locations.Add(new Location("Community Chest", new Vector3(-15.0f, 0f, 25.0f)));
            this.locations.Add(new Property("Denso Hall", 3750, 500, 40, new Vector3(-11.0f, 0f, 25.0f), new int[] {1, 3}));
            this.locations.Add(new Tax("Income Tax", 600, new Vector3(-6.0f, 0f, 25.0f)));
            this.locations.Add(new Railroad("City Station Railroad", new Vector3(-2.0f, 0f, 25.0f)));
            this.locations.Add(new Property("Burns Road", 6500, 500, 60, new Vector3(3.0f, 0f, 25.0f), new int[] {6, 8, 9}));
            this.locations.Add(new Location("Chance", new Vector3(7.0f, 0f, 25.0f)));
            this.locations.Add(new Property("Liaquatabad", 1850, 500, 60, new Vector3(12.0f, 0f, 25.0f), new int[] {6, 8, 9}));
            ...
            this.locations.Add(new Property("Bolten Market", 1450, 100, 10, new Vector3(23.0f, 0f, 19.0f), new int[] {11, 13, 14}));
            this.locations.Add(new Utility("Electric Company", new Vector3(23.0f, 0f, 14.0f)));
            this.locations.Add(new Property("Tower", 1750, 100, 10, new Vector3(23.0f, 0f, 10.0f), new int[] {11, 13, 14}));
            this.locations.Add(new Property("Tariq Road", 5500, 1000, 120, new Vector3(23.0f, 0f, 5.0f), new int[] {11, 13, 14}));
            this.locations.Add(new Railroad("Cantt Station", new Vector3(23.0f, 0f, 0.0f)));
            this.locations.Add(new Property("Soldier Bazzar", 3500, 1000, 140, new Vector3(23.0f, 0f, -4.0f), new int[] {16, 18, 19}));
            this.locations.Add(new Location("Community Chest", new Vector3(23.0f, 0f, -8.0f)));
            this.locations.Add(new Property("New Karachi", 4500, 1000, 140, new Vector3(23.0f, 0f, -13.0f), new int[] {16, 18, 19}));
            this.locations.Add(new Property("Malir Cantt", 2000, 100, 160, new Vector3(23.0f, 0f, -17.0f), new int[] {16, 18, 19}));
            this.locations.Add(new Location("Free Parking", new Vector3(23.0f, 0f, -24.0f)));
            this.locations.Add(new Property("Haideri Market", 6500, 1500, 180, new Vector3(17.0f, 0f, -24.0f), new int[] {21, 23, 24}));
            this.locations.Add(new Location("Chance", new Vector3(12.0f, 0f, -24.0f)));
            this.locations.Add(new Property("Saddar Market", 3000, 1500, 180, new Vector3(8.0f, 0f, -24.0f), new int[] {21, 23, 24}));
            this.locations.Add(new Property("Empress Market", 2250, 1500, 200, new Vector3(3.0f, 0f, -24.0f), new int[] {21, 23, 24}));
            this.locations.Add(new Railroad("Drigh Road Station", new Vector3(-1.0f, 0f, -24.0f)));
            this.locations.Add(new Property("Sarafa Bazzar", 4500, 1500, 220, new Vector3(-6.0f, 0f, -24.0f), new int[] {26, 27, 29}));
            this.locations.Add(new Property("Jama Cloth Market", 3500, 1500, 220, new Vector3(-10.0f, 0f, -24.0f), new int[] {26, 27, 29}));
            this.locations.Add(new Utility("Water Works", new Vector3(-15.0f, 0f, -24.0f)));
            this.locations.Add(new Property("Gulshan-e-Iqbal", 3750, 1500, 240, new Vector3(-19.0f, 0f, -24.0f), new int[] {26, 27, 29}));
            this.locations.Add(new Location("Go To Jail", new Vector3(-25.0f, 0f, -24.0f)));
            this.locations.Add(new Property("Gulzar-e-Hijri", 8000, 2000, 260, new Vector3(-25.0f, 0f, -18.0f), new int[] {31, 32, 34}));
            this.locations.Add(new Property("Juna Market", 2250, 1000, 260, new Vector3(-25.0f, 0f, -14.0f), new int[] {31, 32, 34}));
            this.locations.Add(new Location("Community Chest", new Vector3(-25.0f, 0f, -9.0f)));
            this.locations.Add(new Property("I.I. Chundrigar Road", 9000, 2000, 280, new Vector3(-25.0f, 0f, -4.0f), new int[] {31, 32, 34}));
            ...
            this.locations.Add(new Property("Clifton", 10000, 2000, 350, new Vector3(-25.0f, 0f, 10.0f), new int[] {37, 39}));
            this.locations.Add(new Tax("Luxury Tax", 100, new Vector3(-25.0f, 0f, 14.0f)));
            this.locations.Add(new Property("Keamari", 1000, 200, 50, new Vector3(-25.0f, 0f, 19.0f), new int[] {37, 39}));
        ...
        public void SetUpCards()
        {
            ...
            this.chanceCards.Add(new Card("You have been elected chairman of the board. Pay the bank RS 500.", -500, null));
            this.chanceCards.Add(new Card("Advance to Keamari", 0, 39));
            this.chanceCards.Add(new Card("Your building loan matures. Collect RS 1500.", 1500, null));
            this.chanceCards.Add(new Card("Advance to GO.", 0, 0));
            this.chanceCards.Add(new Card("Bank pays you dividend of RS 500.", 500, null));
            this.chanceCards.Add(new Card("General repairs - pay RS 1000", -1000, null));
            this.chanceCards.Add(new Card("Advance to Bolten Market.", 0, 11));
            this.chanceCards.Add(new Card("Advance to Empress Market.", 0, 24));
            this.chanceCards.Add(new Card("GO TO JAIL, pay RS 500.", -500, 10));
            this.chanceCards.Add(new Card("Take a trip to City Station Railroad.", 0, 5));
            this.chanceCards.Add(new Card("Speeding fine RS 150.", -150, null));

            this.communityChestCards = new List<Card>();
            this.communityChestCards.Add(new Card("Pay hospital fees of RS 1000.", -1000, null));
            this.communityChestCards.Add(new Card("From sale of stock you get RS 500.", 500, null));
            this.communityChestCards.Add(new Card("Income tax refund. Collect RS 200.", 200, null));
            this.communityChestCards.Add(new Card("It is your birthday. Collect RS 300.", 300, null));
            this.communityChestCards.Add(new Card("You inherit RS 1000.", 1000, null));
            this.communityChestCards.Add(new Card("Street repairs - pay RS 800.", -800, null));
            this.communityChestCards.Add(new Card("Holiday fund matures. Receive RS 1000.", 1000, null));
            this.communityChestCards.Add(new Card("You have won second prize in a beauty contest. Collect RS 100.", 100, null));
            this.communityChestCards.Add(new Card("Receive RS 250 consultancy fee.", 250, null));
            this.communityChestCards.Add(new Card("Bank error in your favour. Collect RS 2000.", 2000, null));
            this.communityChestCards.Add(new Card("GO TO JAIL, pay RS 500.", -500, 10));
            this.communityChestCards.Add(new Card("Life insurance matures. Collect RS 1000.", 1000, null));
            this.communityChestCards.Add(new Card("Doctor's fees. Pay RS 500.", -500, null));
            this.communityChestCards.Add(new Card("Advance to GO.", 0, 0));
            this.communityChestCards.Add(new Card("Pay school fees of RS 500.", -500, null));
